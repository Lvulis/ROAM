...
The package also provides functionality to automatically generate an `sf` vector geometry (i.e. a linestring) of the shoreline for use in RivGraph or in a GIS. 
